...
<aside class="dashboard_left box-padding ">
  <div class="dashboard_left-container">
    ...
    <div class="dashboard_left-container-button mb-4 ">
      <a href="{{route('admin.user.edit' , ['user' => Auth::user()->id])}}" class="box-padding mb-1"><span class="mr-2"><i class="fas fa-edit  fa-2x"></i></span><h5> Modifica i tuoi dati</h5></a>

      <a href="{{route('home')}}" class="box-padding mb-1"><span class="mr-2 "><i class="fas fa-home  fa-2x  mr-2"></i></span><h5>Dashboard</h5></a>

      <a href="{{ route('admin.plates.index') }}" class="box-padding mb-1"><span class="mr-2"><i class="fas fa-eye fa-2x mr-2"></i></span><h5>Visualizza Menù</h5></a>
